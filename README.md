...
vista-plat-secret-hub is a Java project for platform engineering. It focuses on this technical goal: Package a Java local lab for secret analysis with fixture event logs, golden state snapshots, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 175, risk penalty 5, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
