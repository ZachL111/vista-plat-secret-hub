"""Regression checks for the vista-plat-secret-hub casebook."""
...
from casebook.harness import assert_expected, vista_plat_secret_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vista_plat_secret_hub_summary(), assert_expected())
